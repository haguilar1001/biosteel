// ==========================================================
// Terceros — datos maestros de clientes y proveedores.
// Solo lectura en esta fase (crear/editar llega con las acciones).
// ==========================================================
    ...
    <>
      <div className="page-head">
        <div>
          ...
          <h1>Terceros</h1>
          <p>Clientes y proveedores · {terceros.length} registros</p>
        </div>
      </div>

      <div className="card">
        <div className="chart-head">Listado de terceros</div>
